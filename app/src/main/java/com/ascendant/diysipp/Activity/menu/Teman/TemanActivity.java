package com.ascendant.diysipp.Activity.menu.Teman;
...
import com.ascendant.diysipp.Adapter.Home.AdapterTeman;
...
public class TemanActivity extends AppCompatActivity {
    ...
    RelativeLayout Back;
    DB_Helper dbHelper;
    String Username, Password, Nama, Token, Level, Photo,Kelas;
    ...
    private void Logic() {
        ...
        Call<ResponseModel> Temans = api.Teman(destiny.AUTH(Token),Kelas);
                ...
                try {
                    if (response.body().getStatusCode().equals("000")) {
                        ...
                        if (mItems.size() < 1) {
                            ...
                            TAnim.setText("Teman Kelas Belum Ada");
                        ...
                        Intent intent = new Intent(TemanActivity.this, MainActivity.class);
