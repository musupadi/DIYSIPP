package com.ascendant.diysipp.Activity.Sponsor;
...
import com.ascendant.diysipp.Adapter.Universal.AdapterAllSponsor;
...
public class SponsorActivity extends AppCompatActivity {
    ...
    private void Logic(){
        mManager = new GridLayoutManager(SponsorActivity.this,1);
        ...
        Call<ResponseModel> Temans = api.Sponsor(destiny.AUTH(Token));
        Temans.enqueue(new Callback<ResponseModel>() {
                ...
                try {
                    if (response.body().getStatusCode().equals("000")){
                        ...
                        if (mItems.size()<1){
                            ...
                            mAdapter = new AdapterAllSponsor(SponsorActivity.this,mItems);
                            recycler.setAdapter(mAdapter);
                            mAdapter.notifyDataSetChanged();
                        }
                    }else if (response.body().getStatusCode().equals("001") || response.body().getStatusCode().equals("002")){
                        destiny.AutoLogin(Username,Password,SponsorActivity.this);
                        Intent intent = new Intent(SponsorActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }else{
                        Toast.makeText(SponsorActivity.this, "Terjadi Kesalahan ", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Toast.makeText(SponsorActivity.this, "Terjadi Kesalahan User akan Terlogout", Toast.LENGTH_SHORT).show();
                    dbHelper.Logout();
                    Intent intent = new Intent(SponsorActivity.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(SponsorActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}