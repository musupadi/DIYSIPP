package com.ascendant.diysipp.Activity.menu.Guru;
    ...
    private void Logic(){
        ...
        Temans.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                try {
                    if (response.body().getStatusCode().equals("000")){
                        ...
                        Toast.makeText(GuruActivity.this, "Terjadi Kesalahan ", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Toast.makeText(GuruActivity.this, "Terjadi Kesalahan User akan Terlogout", Toast.LENGTH_SHORT).show();
                    dbHelper.Logout();
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(GuruActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}