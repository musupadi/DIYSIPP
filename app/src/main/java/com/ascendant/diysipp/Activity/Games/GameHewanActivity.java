...
import com.ascendant.diysipp.Adapter.Universal.AdapterHewan;
        ...
        Temans.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                try {
                    ...
                    Toast.makeText(GameHewanActivity.this, "Terjadi Kesalahan User akan Terlogout", Toast.LENGTH_SHORT).show();
                    dbHelper.Logout();
                    Intent intent = new Intent(GameHewanActivity.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
