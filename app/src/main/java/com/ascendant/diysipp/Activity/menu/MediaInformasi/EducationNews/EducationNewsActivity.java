package com.ascendant.diysipp.Activity.menu.MediaInformasi.EducationNews;
...
public class EducationNewsActivity extends AppCompatActivity {
    ...
    private void Logic(){
        mManager = new GridLayoutManager(EducationNewsActivity.this,1);
        ...
        Temans.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                try {
                    if (response.body().getStatusCode().equals("000")){
                        ...
                        mAdapter = new AdapterMediaInformasi(EducationNewsActivity.this,mItems);
                        recycler.setAdapter(mAdapter);
                        mAdapter.notifyDataSetChanged();
                    }else if (response.body().getStatusCode().equals("001") || response.body().getStatusCode().equals("002")){
                        Logic();
                    }else{
                        Toast.makeText(EducationNewsActivity.this, "Terjadi Kesalahan ", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Toast.makeText(EducationNewsActivity.this, "Terjadi Kesalahan User akan Terlogout", Toast.LENGTH_SHORT).show();
                    dbHelper.Logout();
                    Intent intent = new Intent(EducationNewsActivity.this, LoginActivity.class);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(EducationNewsActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}