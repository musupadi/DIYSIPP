package com.ascendant.diysipp.Activity.menu.MediaInformasi.Giveaway;
    ...
    private void Logic(){
        ...
        Temans.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                try {
                    if (response.body().getStatusCode().equals("000")){
                        ...
                        mAdapter = new AdapterMediaInformasi(GiveawayActivity.this,mItems);
                        recycler.setAdapter(mAdapter);
                        mAdapter.notifyDataSetChanged();
                    }else if (response.body().getStatusCode().equals("001") || response.body().getStatusCode().equals("002")){
                        Logic();
                    }else{
                        Toast.makeText(GiveawayActivity.this, "Terjadi Kesalahan ", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Toast.makeText(GiveawayActivity.this, "Terjadi Kesalahan User akan Terlogout", Toast.LENGTH_SHORT).show();
                    dbHelper.Logout();
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(GiveawayActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}