...
import com.ascendant.diysipp.Activity.menu.Kebudayaan.CeritaSunda.DetailCeritaSundaActivity;
import com.ascendant.diysipp.Activity.menu.Kebudayaan.SejarahSunda.DetailSejarahSundaActivity;
...
public class AdapterKemisNyunda extends RecyclerView.Adapter<AdapterKemisNyunda.HolderData> {
    ...
    Destiny destiny;
    public AdapterKemisNyunda(Context ctx, List<DataModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(@NonNull final HolderData holderData, int posistion) {
        ...
        holderData.Judul.setText(dm.getJudul_kemis_nyunda());
        ...
        holderData.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (dm.getTipe_kemis_nyunda().equals("cerita")){
                    ...
                    i.putExtra("GAMBAR",destiny.BASE_URL()+dm.getCover_kemis_nyunda());
