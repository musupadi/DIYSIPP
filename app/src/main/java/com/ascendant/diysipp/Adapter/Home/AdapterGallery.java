...
public class AdapterGallery extends RecyclerView.Adapter<AdapterGallery.HolderData> {
    ...
    Destiny destiny;
    public AdapterGallery (Context ctx, List<DataModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(@NonNull final HolderData holderData, int posistion) {
        ...
        holderData.text.setText(dm.getDeskripsi_foto());
    }
