...
public class AdapterMediaPembelajarans extends RecyclerView.Adapter<AdapterMediaPembelajarans.HolderData> {
    ...
    Destiny destiny;
    public AdapterMediaPembelajarans(Context ctx, List<DataModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
