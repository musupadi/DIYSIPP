...
public class SpinnerDaerah extends ArrayAdapter<DataModel> {
    public SpinnerDaerah(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_daerah());
            textId.setText(currentItem.getId_daerah());
        }
        return convertView;
    }
}
