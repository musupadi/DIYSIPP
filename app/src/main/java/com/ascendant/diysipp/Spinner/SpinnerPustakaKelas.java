...
public class SpinnerPustakaKelas extends ArrayAdapter<DataModel> {
    public SpinnerPustakaKelas(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getKelas_ke());
            textId.setText(currentItem.getKelas_ke());
        }
        return convertView;
    }
}
